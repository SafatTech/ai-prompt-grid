...
**Status:** Phase 0 docs drafted — awaiting your approval pass  
**Last updated:** 2026-09-12  

**Competitor + reference (locked):** [proxima.art](https://proxima.art/) — see [competitor-proxima.md](./competitor-proxima.md)
...
| Content model & taxonomy | [content-model.md](./content-model.md) | Entities, fields, categories, models, RLS intent |
| Launch catalog brief | [catalog-brief.md](./catalog-brief.md) | 24 launch styles + prompt checklist |
| Legal & trust | [legal-trust.md](./legal-trust.md) | Image rules, privacy/terms outline |
